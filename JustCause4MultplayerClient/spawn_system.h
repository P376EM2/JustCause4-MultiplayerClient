...
class CSpawnSystem
{
  public:
    ...
    {
        return **(CSpawnSystem**)GetAddress(offsets::INST_SPAWN_SYSTEM);
    }
               ...
               std::function<void(const spawned_objects&, void*)> callback, void* userdata = nullptr)
    {
        ...
        meow_hook::func_call<void>(
            GetAddress(offsets::SPAWN_SYSTEM_SPAWN), this, model_name.c_str(), transform, 0x597Cu,
                              ...
                              std::vector<SResourceDef*, jc::allocator<SResourceDef*>>* out_resources)
    {
        ...
        auto count = meow_hook::func_call<int64_t>(GetAddress(offsets::SPAWN_SYSTEM_PARSE_TAGS), this, model_name.c_str(), &tags,
                                                   &invalid_tags);
        if (!count) {
        ...
        meow_hook::func_call<void>(GetAddress(offsets::SPAWN_SYSTEM_GET_MATCHING_RESOURCES), this, &tags, out_resources, false,
                                   "", 0xDEADBEEF);
