...
struct SPartialModelData {
  public:
    SPartialModelData()
    {
        m_skinTintData = (void*)(*(uintptr_t*)GetAddress(offsets::INST_CHARACTER_MANAGER) + 0x270);
    }
...
class CCharacter
{
  public:
    ...
    {
        return meow_hook::func_call<CGameObject*>(GetAddress(offsets::CHARACTER_GET_VEHICLE_PTR), this);
    }
